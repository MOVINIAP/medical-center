                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search12" class="input-text header-searchbar" placeholder="Buscar nombre de paciente o correo electrónico" list="patient">&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan="4" style="padding-top:0px;width: 100%;" >
                        ...
                        <select name="showonly" id="" class="box filter-container-items" style="width:90% ;height: 37px;margin: 0;" >
                                    ...
                                    <option value="Mis">Sólo mis pacientes</option><br/>
                                    <option value="Todos los">Todos los pacientes</option><br/>
