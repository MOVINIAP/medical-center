                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>¿No tiene ni idea de médicos? No hay problema, saltemos a la sección de
                                <a href="doctors.php" class="non-style-link"><b>"Todos los Doctores"</b></a> o 
                                <a href="schedule.php" class="non-style-link"><b>"Sesiones"</b> </a><br>
                                Seguimiento del historial de citas pasadas y futuras.<br>Averigüe también la hora prevista de llegada de su médico o asesor médico.<br><br>
                            </p>
                            
                            <h3>Contactar a un médico aquí</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Busque un doctor y encontraremos alguna sesión disponible" list="doctors" style="width:45%;">&nbsp;&nbsp;
                        ...
                        <table border="0" width="100%"">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="font-size: 20px;font-weight:600;padding-left: 40px;" class="anime">Su próxima reserva</p>
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <br>
                                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Nada para mostrar aquí!</p>
                                                    <a class="non-style-link" href="schedule.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Canalizar a un médico &nbsp;</font></button>
                                                    </a>
                                                    </center>
                                                    <br><br><br><br>
                                                    </td>
