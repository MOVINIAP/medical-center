...
<body>
    ...
    $userrow = $result->fetch_assoc(); // Cambiar $userfetch a $userrow
    $userid= $userrow["pid"];
                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Buscar nombre del médico, correo electrónico o fecha (YYYY-MM-DD)" list="doctors" >&nbsp;&nbsp;
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            Título de la sesión: '.$title.'<br>
                                                            Fecha prevista de la sesión: '.$scheduledate.'<br>
                                                            Inicio de la sesión : '.$scheduletime.'<br>
                                                            Tasa de canalización : <b>LKR.2 000.00</b>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="Submit" class="login-btn btn-primary btn btn-book" style="margin-left:10px;padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;" value="Reserve ahora" name="booknow"></button>
                                            </form>
                                            </td>
                                        </tr>
                                        '; 
