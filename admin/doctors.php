            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="email" name="email" class="input-text" placeholder="Dirección de correo electrónicos" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                        <input type="email" name="email" class="input-text" placeholder="Dirección de correo electrónicos" value="'.$email.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
